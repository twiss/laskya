(function(laskya) {
	if(typeof exports !== 'undefined') {
		module.exports = require('../BigDecimal/build/BigDecimal-all-last');
		laskya(module.exports, module.exports.MathContext, module.exports.BigDecimal);
	} else {
	...
	Solutions.prototype.addSolution = function(varName, solutions) {
		if(solutions) {
			if(this[varName]) this[varName] = new OneOf(_.toArray(this[varName]).concat(_.toArray(solutions)));
	...
	var $return = new SyntaxError('Illegal return statement'),
		...
		toBigDecimal = function(n) {
			...
			if(_.isNumber(n) && !isFinite(n)) return n;
		...
		scopes = [{}, _.merge((function() {
			...
			alert: setflag(global.alert ? function() {
				global.alert.apply(this, arguments);
			} : function() {}, 'functionimpure'),
			'throw': function(err) {
				throw err;
			},
		...
		compare = function(a, b) {
			...
			if(a && b && a.toBigDecimal && b.toBigDecimal) return a.toBigDecimal().compareTo(b.toBigDecimal());
			if(a === b) return 0;
			if(a < b) return -1;
			if(a > b) return 1;
		},
		...
		calculate = function(input) {
			...
			switch(type) {
				...
				case 'invocation':
					...
					thisObj.input = input;
					return saveInTree(fn.apply(thisObj, args));
				case 'block':
